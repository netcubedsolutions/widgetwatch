# Widget Watch Mobile Redesign Spec
...
**Target:** Single line: "Widget Watch · Independent · About & Disclaimer" with the BMAC button. Hub links and data source links hidden on mobile (they're accessible via the nav tabs and About modal).
...
**Target:** Stat values: 13px bold. Stat labels: 10px muted. Header "Widget Watch" stays 14px. "LIVE · 673 flights" slightly emphasized. Create clear visual weight: header > live count > stats.
